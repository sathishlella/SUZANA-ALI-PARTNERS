export const firm = {
  ...
  ipohEmail: "admin.ipoh@suzanaali.com",
  offices: [
    {
      id: "kota-damansara",
      city: "Kota Damansara",
      label: "Petaling Jaya Office",
    ...
    },
    {
      ...
      email: "admin.ipoh@suzanaali.com",
      emailEnv: "SUZANA_EMAIL"
    }
  ]
};
...
export const practiceGroups = [
  {
    ...
    summary: "Islamic finance, banking disputes, insolvency, bankruptcy, debt recovery and execution proceedings.",
    matters: ["Banking law", "Islamic finance", "Debt recovery", "Bankruptcy & insolvency", "Enforcement proceedings"]
  },
  {
...
export const panelPartners = [
  { name: "Medical Device Authority, Ministry of Health Malaysia", logo: "" },
