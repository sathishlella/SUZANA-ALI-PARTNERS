...
export async function sendBookingEmails(booking) {
  const recipient = booking.officeEmail;
  ...
  const clientHtml = htmlShell(
    ...
    `
      ...
      <p>Thank you. Your consultation request has been received for <strong>${booking.slotLabel}</strong> at <strong>${booking.officeLabel}</strong>.</p>
  ...
  const firmHtml = htmlShell(
    ...
    `
      <p><strong>Office:</strong> ${booking.officeLabel}</p>
